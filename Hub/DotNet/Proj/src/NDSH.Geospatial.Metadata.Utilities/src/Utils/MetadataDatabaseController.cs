...
namespace NDSH.Geospatial.Metadata.Utilities.Utils {
  ...
  public class MetadataDatabaseController {
    ...
    public List<BgsLayer>? GetBgsLayers(string xmlFilePath, Logger logger) {
      ...
      Uri? getJsonUrl(Uri? uri) {
        ...
        var query = System.Web.HttpUtility.ParseQueryString(jsonUrl.Query);
        query["f"] = "pjson";
    ...
    public void LoadEmptyTitleComparisonRecords() {
      ...
      ImmutableSortedDictionary<int, string> sortedDictionary = this.GetAllTitles();
    ...
    public void OpenDatabase(string databasePath, DatabaseOption databaseOption) {
      ...
      _context = new MetadataContext(this.DatabasePath, this.DatabaseOption);
    }
