...
// Member of         : 
// Description       : 
// Created by        : 05/01/2023, 00:05, @gisvlasta.
...
namespace NDSH.Geospatial.Metadata.V2003.XmlSchema.Catalogues.CRS.Multilingual.CoordinateReferenceSystems
{
  ...
  /// </summary>
  [Serializable]
  [XmlType("ML_VerticalCRS", Namespace = "http://www.isotc211.org/2005/gmx")]
  [XmlRoot("ML_VerticalCRS", Namespace = "http://www.isotc211.org/2005/gmx", IsNullable = false)]
  [JsonObject("ML_VerticalCRS")]
  public class ML_VerticalCRS_Type : VerticalCRSType {

    #region Constructors - Destructors

    /// <summary>
    /// Initializes the <see cref="ML_VerticalCRS_Type"/>.
    /// </summary>
