...
// Updated by        : 10/01/2023, 01:52, @gisvlasta. - 1.0.1: Added xmlns field.
// Version           : 1.0.1
...
namespace NDSH.Geospatial.Metadata.V2003.XmlSchema.Catalogues.CRS.Multilingual {
  ...
  /// </remarks>
  [Serializable]
  [XmlType("CoordinateSystemAlt", Namespace = "http://www.isotc211.org/2005/gmx")]
  [XmlRoot("CoordinateSystemAlt", Namespace = "http://www.isotc211.org/2005/gmx", IsNullable = false)]
  [JsonObject("CoordinateSystemAlt")]
  public class CoordinateSystemAlt_Type : IdentifiedObjectType, IAlternative {

    #region Constructors - Destructors

    /// <summary>
    /// Initializes the <see cref="CoordinateSystemAlt_Type"/>.
    /// </summary>
