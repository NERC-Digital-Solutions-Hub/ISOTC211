...
// Member of         : 
// Description       : 
// Created by        : 04/01/2023, 03:36, @gisvlasta.
// Updated by        : 10/01/2023, 20:55, @gisvlasta. - 1.0.1: Added xmlns field.
// Version           : 1.0.1
...
namespace NDSH.Geospatial.Metadata.V2003.XmlSchema.Catalogues.UnitsOfMeasure {
  ...
  /// </summary>
  [Serializable]
  [XmlType("ML_BaseUnit", Namespace = "http://www.isotc211.org/2005/gmx")]
  [XmlRoot("ML_BaseUnit", Namespace = "http://www.isotc211.org/2005/gmx", IsNullable = false)]
  [JsonObject("ML_BaseUnit")]
  public class ML_BaseUnit_Type : BaseUnitType {

    #region Constructors - Destructors

    /// <summary>
    /// Initializes the <see cref="ML_BaseUnit_Type"/>.
    /// </summary>
