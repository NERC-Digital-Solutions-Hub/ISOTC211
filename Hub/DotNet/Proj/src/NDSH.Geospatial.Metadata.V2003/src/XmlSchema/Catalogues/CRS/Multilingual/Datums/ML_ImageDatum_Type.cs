...
// Updated by        : 10/01/2023, 20:41, @gisvlasta. - 1.0.1: Added xmlns field.
// Version           : 1.0.1
...
namespace NDSH.Geospatial.Metadata.V2003.XmlSchema.Catalogues.CRS.Multilingual.Datums
{
  ...
  /// </summary>
  [Serializable]
  [XmlType("ML_ImageDatum", Namespace = "http://www.isotc211.org/2005/gmx")]
  [XmlRoot("ML_ImageDatum", Namespace = "http://www.isotc211.org/2005/gmx", IsNullable = false)]
  [JsonObject("ML_ImageDatum")]
  public class ML_ImageDatum_Type : ImageDatumType, IDatumsAlternativeExpression {

    #region Constructors - Destructors

    /// <summary>
    /// Initializes the <see cref="ML_ImageDatum_Type"/>.
    /// </summary>
