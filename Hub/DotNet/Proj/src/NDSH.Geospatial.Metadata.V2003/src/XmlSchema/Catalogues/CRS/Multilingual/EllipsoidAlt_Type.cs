...
// Updated by        : 10/01/2023, 02:06, @gisvlasta. - 1.0.1: Added xmlns field.
// Version           : 1.0.1
...
namespace NDSH.Geospatial.Metadata.V2003.XmlSchema.Catalogues.CRS.Multilingual {
  ...
  /// </remarks>
  [Serializable]
  [XmlType("EllipsoidAlt", Namespace = "http://www.isotc211.org/2005/gmx")]
  [XmlRoot("EllipsoidAlt", Namespace = "http://www.isotc211.org/2005/gmx", IsNullable = false)]
  [JsonObject("EllipsoidAlt")]
  public class EllipsoidAlt_Type : IdentifiedObjectType, IAlternative {

    #region Constructors - Destructors

    /// <summary>
    /// Initializes the <see cref="EllipsoidAlt_Type"/>.
    /// </summary>
