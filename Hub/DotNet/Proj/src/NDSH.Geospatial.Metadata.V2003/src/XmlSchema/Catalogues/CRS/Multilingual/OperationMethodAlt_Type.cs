...
// Updated by        : 10/01/2023, 02:15, @gisvlasta. - 1.0.1: Added xmlns field.
// Version           : 1.0.1
...
namespace NDSH.Geospatial.Metadata.V2003.XmlSchema.Catalogues.CRS.Multilingual {
  ...
  /// </remarks>
  [Serializable]
  [XmlType("OperationMethodAlt", Namespace = "http://www.isotc211.org/2005/gmx")]
  [XmlRoot("OperationMethodAlt", Namespace = "http://www.isotc211.org/2005/gmx", IsNullable = false)]
  [JsonObject("OperationMethodAlt")]
  public class OperationMethodAlt_Type : IdentifiedObjectType, IAlternative {

    #region Constructors - Destructors

    /// <summary>
    /// Initializes the <see cref="OperationMethodAlt_Type"/>.
    /// </summary>
