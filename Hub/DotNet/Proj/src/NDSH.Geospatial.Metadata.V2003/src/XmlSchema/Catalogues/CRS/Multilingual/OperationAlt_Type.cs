...
// Member of         : 
// Description       : 
// Created by        : 06/01/2023, 15:09, @gisvlasta.
// Updated by        : 10/01/2023, 02:10, @gisvlasta. - 1.0.1: Added xmlns field.
// Version           : 1.0.1
...
namespace NDSH.Geospatial.Metadata.V2003.XmlSchema.Catalogues.CRS.Multilingual
{
  ...
  /// </remarks>
  [Serializable]
  [XmlType("OperationAlt", Namespace = "http://www.isotc211.org/2005/gmx")]
  [XmlRoot("OperationAlt", Namespace = "http://www.isotc211.org/2005/gmx", IsNullable = false)]
  [JsonObject("OperationAlt")]
  public class OperationAlt_Type : AbstractCoordinateOperationType, IAlternative {

    #region Constructors - Destructors

    /// <summary>
    /// Initializes the <see cref="OperationAlt_Type"/>.
    /// </summary>
