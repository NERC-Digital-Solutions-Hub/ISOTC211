...
// Updated by        : 10/01/2023, 20:10, @gisvlasta. - 1.0.1: Added xmlns field.
// Version           : 1.0.1
...
namespace NDSH.Geospatial.Metadata.V2003.XmlSchema.Catalogues.CRS.Multilingual.CoordinateOperations
{
  ...
  /// </summary>
  [Serializable]
  [XmlType("ML_OperationParameterGroup", Namespace = "http://www.isotc211.org/2005/gmx")]
  [XmlRoot("ML_OperationParameterGroup", Namespace = "http://www.isotc211.org/2005/gmx", IsNullable = false)]
  [JsonObject("ML_OperationParameterGroup")]
  public class ML_OperationParameterGroup_Type : OperationParameterGroupType, IOperationParametersAlternativeExpression {

    #region Constructors - Destructors

    /// <summary>
    /// Initializes the <see cref="ML_OperationParameterGroup_Type"/>.
    /// </summary>
