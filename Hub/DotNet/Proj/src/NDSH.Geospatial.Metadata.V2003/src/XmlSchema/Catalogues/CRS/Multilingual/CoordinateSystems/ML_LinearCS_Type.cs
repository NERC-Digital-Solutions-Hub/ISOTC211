...
// Member of         : 
// Description       : 
// Created by        : 05/01/2023, 03:11, @gisvlasta.
// Updated by        : 10/01/2023, 20:35, @gisvlasta. - 1.0.1: Added xmlns field.
// Version           : 1.0.1
...
namespace NDSH.Geospatial.Metadata.V2003.XmlSchema.Catalogues.CRS.Multilingual.CoordinateSystems
{
  ...
  /// </summary>
  [Serializable]
  [XmlType("ML_LinearCS", Namespace = "http://www.isotc211.org/2005/gmx")]
  [XmlRoot("ML_LinearCS", Namespace = "http://www.isotc211.org/2005/gmx", IsNullable = false)]
  [JsonObject("ML_LinearCS")]
  public class ML_LinearCS_Type : LinearCSType {

    #region Constructors - Destructors

    /// <summary>
    /// Initializes the <see cref="ML_LinearCS_Type"/>.
    /// </summary>
