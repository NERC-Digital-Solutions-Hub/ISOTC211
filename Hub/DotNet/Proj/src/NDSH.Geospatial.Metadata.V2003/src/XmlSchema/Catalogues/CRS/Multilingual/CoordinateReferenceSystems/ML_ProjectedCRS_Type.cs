...
// Member of         : 
// Description       : 
// Created by        : 05/01/2023, 00:53, @gisvlasta.
...
namespace NDSH.Geospatial.Metadata.V2003.XmlSchema.Catalogues.CRS.Multilingual.CoordinateReferenceSystems
{
  ...
  /// </summary>
  [Serializable]
  [XmlType("ML_ProjectedCRS", Namespace = "http://www.isotc211.org/2005/gmx")]
  [XmlRoot("ML_ProjectedCRS", Namespace = "http://www.isotc211.org/2005/gmx", IsNullable = false)]
  [JsonObject("ML_ProjectedCRS")]
  public class ML_ProjectedCRS_Type : ProjectedCRSType {

    #region Constructors - Destructors

    /// <summary>
    /// Initializes the <see cref="ML_ProjectedCRS_Type"/>.
    /// </summary>
