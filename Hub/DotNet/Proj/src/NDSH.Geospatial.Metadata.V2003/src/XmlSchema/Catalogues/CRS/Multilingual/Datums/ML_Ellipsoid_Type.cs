...
// Member of         : 
// Description       : 
// Created by        : 06/01/2023, 19:42, @gisvlasta.
// Updated by        : 10/01/2023, 20:43, @gisvlasta. - 1.0.1: Added xmlns field.
// Version           : 1.0.1
...
namespace NDSH.Geospatial.Metadata.V2003.XmlSchema.Catalogues.CRS.Multilingual.Datums
{
  ...
  public class ML_Ellipsoid_Type : EllipsoidType, IEllipsoidsAlternativeExpression {
    ...
    public ML_Ellipsoid_Type() {
      ...
      _alternativeExpression  = default; //  new List<EllipsoidAlt_PropertyType>();
    ...
    private List<EllipsoidAlt_PropertyType> _alternativeExpression;
