...
// Member of         : 
// Description       : 
// Created by        : 22/12/2022, 20:09, @gisvlasta.
// Updated by        : 
// Version           : 1.0.0
...
namespace NDSH.Geospatial.Metadata.V2003.Common.Extent {
  ...
  public class EX_SpatialTemporalExtent_PropertyType : ObjectReference_PropertyType {
    ...
    /// <summary>
    /// Initialzies the <see cref="EX_SpatialTemporalExtent_PropertyType"/>.
    /// </summary>
    ...
    public EX_SpatialTemporalExtent_Type EX_SpatialTemporalExtent {
      ...
      set {
        ...
        if (_ex_SpatialTemporalExtent == null || _ex_SpatialTemporalExtent.Equals(value) != true) {
