    ...
    public object DateOrDateTime {
      ...
      set {
        ...
        if (_item == null || _item.Equals(value) != true) {
          ...
          if (_item.GetType() == typeof(string)) { // TODO: Danger !!! - Perhaps this is not a good idea. When deserializaing it may need to have the 'DateTimeType' property set already, otherwise the deserialization will not be correct.
