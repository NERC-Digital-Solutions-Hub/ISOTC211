...
// Member of         : 
// Description       : 
// Created by        : 28/12/2022, 18:53, @gisvlasta.
// Updated by        : 
// Version           : 1.0.0
...
namespace NDSH.Geospatial.Metadata.V2003.ConceptualSchema.Derived.UnitsOfMeasure {
  ...
  /// </summary>
  [Serializable]
  [XmlType("UomVelocity_PropertyType", Namespace = "http://www.isotc211.org/2005/gco")]
  [JsonObject("UomVelocity_PropertyType")]
  public class UomVelocity_PropertyType : ObjectReference_PropertyType {

    #region Constructors - Destructors

    /// <summary>
    /// Initializes the <see cref="UomVelocity_PropertyType"/>.
    /// </summary>
