...
// Member of         : 
// Description       : 
// Created by        : 28/12/2022, 19:02, @gisvlasta.
// Updated by        : 
// Version           : 1.0.0
...
namespace NDSH.Geospatial.Metadata.V2003.ConceptualSchema.Derived.UnitsOfMeasure {
  ...
  /// </summary>
  [Serializable]
  [XmlType("UomArea_PropertyType", Namespace = "http://www.isotc211.org/2005/gco")]
  [JsonObject("UomArea_PropertyType")]
  public class UomArea_PropertyType : ObjectReference_PropertyType {

    #region Constructors - Destructors

    /// <summary>
    /// Initializes the <see cref="UomArea_PropertyType"/>.
    /// </summary>
