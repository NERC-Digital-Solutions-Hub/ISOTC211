...
// Member of         : 
// Description       : 
// Created by        : 28/12/2022, 19:00, @gisvlasta.
// Updated by        : 
// Version           : 1.0.0
...
namespace NDSH.Geospatial.Metadata.V2003.ConceptualSchema.Derived.UnitsOfMeasure {
  ...
  /// </summary>
  [Serializable]
  [XmlType("UomScale_PropertyType", Namespace = "http://www.isotc211.org/2005/gco")]
  [JsonObject("UomScale_PropertyType")]
  public class UomScale_PropertyType : ObjectReference_PropertyType {

    #region Constructors - Destructors

    /// <summary>
    /// Initializes the <see cref="UomScale_PropertyType"/>.
    /// </summary>
